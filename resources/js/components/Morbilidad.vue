        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4>Morbilidad</h4> | <button type="button" class="btn btn-success btn-sm"
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="idNivel" class="form-control"
                                        placeholder="Codigo de la morbilidad">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="email-input">Causa</label>
                                <div class="col-md-9">
                                    <textarea v-model="causas" class="form-control"
                                        placeholder="Causas de la morbilidad" rows="4" cols="100"></textarea>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods: {
            validarNivel() {
                ...
                if (!this.idNivel)
                    this.errorMostrarMsjNivel.push('El id de la morbilidad no puede estar vacio');
                if (!this.causas)
                    this.errorMostrarMsjNivel.push('La causa no puede estar vacia');
            ...
            editNivel(nivel) {
                ...
                axios({
                    ...
                    alertify.success('Morbilidad Editado');
            ...
            createNivel(nivel) {
                ...
                axios({
                    ...
                    me.cerrarModal();
                    Fire.$emit('reloadUsers')
                    alertify.success('Morbilidad agregado');
                }).catch(function (error) {
                    Fire.$emit('reloadUsers')
                    alertify.error('Hubo un error');
                });
            ...
            getUsers() {
                axios.get('/Morbilidad/', { params: this.tableShow })
                    .then(response => {
